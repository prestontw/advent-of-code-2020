...
let day4 = "eyr:2028 iyr:2016 byr:1995 ecl:oth
...
let day7 = "muted tomato bags contain 1 bright brown bag, 1 dotted gold bag, 2 faded gray bags, 1 posh yellow bag.
...
let day11 = "LLLLLLL.L.LL.L.LLLL.LLLLLLL.LLLLL.LLLLLL.LLLLLLL.L.LLL.LLLLLLLL.LLLLLL.LLLLLLLLLLLLLL.LLLLL
...
let day14 = "mask = 001X11X1X010X1X1010XX10X100101011000
mem[43398] = 563312
mem[51673] = 263978
mem[18028] = 544304215
...
let day15 = "13,0,10,12,1,5,8"

let day16 = "departure location: 43-237 or 251-961
...
let day18 = "9 * 7 + ((6 + 9 * 2 + 6 + 7 + 5) * (5 + 9 + 7) * 6) * (4 + 8) + 5 * 8
3 * (4 * 9 + 8 + 4 * 4 + 7) + 7 * (8 * 9)
4 * ((6 * 5 * 9) + 2) + 9 * 4
